...
class FineTuning:
    ...
    def load_data(self, train_path, test_path):
        ...
        train_dataset['text'] = "<|user|>\n" + train_dataset['Questions'] + "<|end|>\n" + "<|assistant|>\n" + train_dataset['Answers']
        test_dataset['text'] = "<|user|>\n" + test_dataset['Questions'] + "<|end|>\n" + "<|assistant|>\n" + test_dataset['Answers']
    ...
    def setup_model(self):
        os.environ["HF_TOKEN"] = "PASTE YOUR HUGGING FACE API TOKEN HERE"
        ...
        lora_model = get_peft_model(model, self.setup_lora())
...
if __name__ == "__main__":
    ...
    ft = FineTuning(model_name, "Phi-3-mini-4k", 64, 16, 0.1) # "meta-llama/Meta-Llama-3-8B"
    train_dataset, test_dataset = ft.load_data("jira_QA.csv", "validation_data.csv")
    fine_tuned_model_name = "Phi-3-mini-4k-instruct-fine-tuned"
