...
class FineTuning:
    ...
    def load_data(self, file_path):
        ...
        dataset['text'] = '<s>[INST] ' + dataset['questions'] + ' [/INST] ' + dataset['answers'] + ' </s>'
        dataset = Dataset.from_pandas(dataset[['text']])
        return dataset

    def setup_model(self):
        os.environ["HF_TOKEN"] = "PASTE YOUR HUGGING FACE API KEY HERE"
...
if __name__ == "__main__":
    ...
    dataset = ft.load_data("../../data/jira_files/jira_QA.csv")
    fine_tuned_model_name = "Llama-2-7b-finetune"
